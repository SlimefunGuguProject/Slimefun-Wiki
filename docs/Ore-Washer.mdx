...
<ImageGallery images={[
  {
    src: 'https://cdn.jsdelivr.net/gh/Slimefun/Wiki@master/images/multiblock-ore-washer.png',
    alt: '建造洗矿机',
    sizePercent: 50
  }
]}/>
...
洗矿机的可用配方在下表中列出，列表基于 1.17.1 版本。<br/>
部分配方可能由于服务器设置被禁用，由附属插件添加的配方不在此列出。<br/>
