...
冶炼炉下方需要有火焰。当冶炼物品时，火焰会随机被熄灭，需要随时重新点燃。查看[提示与技巧](#tips-and-tricks)了解更多信息。
...
<ImageGallery images={[
  {
    src: 'https://cdn.jsdelivr.net/gh/Slimefun/Wiki@master/images/multiblock-smeltery.png',
    alt: '建造冶炼炉',
    sizePercent: 80
  }
]}/>
...
摆放好后，右键点击下界砖栅栏，就可以冶炼物品了。

## 提示与技巧 \{#tips-and-tricks}

由于冶炼炉下方的火焰会经常熄灭，你需要常备打火石，或浏览以下技巧来重新点火：

- 在冶炼炉下方 2 格处放置下界岩，在不使用机器时，火焰就不会自动熄灭了。
